...
export function Sidebar({ currentUser }: { currentUser: SessionUser }) {
  ...
  return (
    <>
      <aside className="surface executive-card sticky top-6 hidden h-[calc(100vh-3rem)] w-[286px] shrink-0 rounded-[28px] p-5 lg:flex lg:flex-col lg:overflow-hidden">
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-hidden">
          <nav className="flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto pr-1 [scrollbar-color:rgba(128,164,137,0.34)_transparent]">
            {navItems
