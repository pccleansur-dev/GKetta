...
export function Sidebar({ currentUser }: { currentUser: SessionUser }) {
  ...
  return (
    <>
      <aside className="surface executive-card sticky top-6 hidden max-h-[calc(100dvh-3rem)] w-[328px] shrink-0 rounded-[28px] p-5 lg:flex lg:flex-col lg:overflow-hidden">
